...
- Crea la clase de la acción en el paquete `org.bfa.PruebaPOO.acciones`, normalmente extendiendo `ViewBaseAction`
...
<controlador nombre="TuPrimeraEntidad">
    ...
    <accion nombre="mostrarImporte" modo="detail"
        clase="org.bfa.PruebaPOO.acciones.MostrarImporte"/>
</controlador>
```

```java
package org.bfa.PruebaPOO.acciones;
...
- ✅ Coloca las clases de acción en `org.bfa.PruebaPOO.acciones`
...
```java
package org.bfa.PruebaPOO.pruebas;
...
- Crea un paquete `cuadrosmando` (ej. `org.bfa.PruebaPOO.cuadrosmando`) y coloca la clase `CuadroMando` y sus clases auxiliares en él.
